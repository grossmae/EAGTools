...
open class EAGViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(EAGViewController.keyboardWasShown(_:)), name:.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(EAGViewController.keyboardWillHide(_:)), name:.UIKeyboardWillHide, object: nil);
    ...
    open func setBottomView(bottomView: UIView) {
